...
export default function Review() {
    return (
        <div className='review__container'>
            ...
            <p className='review__paragraph'><span>It's so good, you'll never want to go back.</span> The Website Artificers replace unreliable freelancers and expensive agencies for one flat yearly fee, with websites delivered so fast that it will blow your mind.</p>
